...
const char *convert_device_id(Device dev)
{
    switch(dev)
    {
        ...
        case KindlePaperWhite2Wifi3GAfrica:
            return "Kindle PaperWhite 2 (2013) Wifi+3G Africa";
...
int kindle_print_help(const char *prog_name)
{
    printf(
        ...
        "      -d, --device pw2ga          Kindle PaperWhite 2 (2013) Wifi+3G Africa\n"
        "      -d, --device kindle5        Alias for k5w, k5g, k5gb, pw, pwg, pwgc, pwgb, pwgj, pwgbr, pw2, pw2j, pw2g, pw2gb, pw2gr, pw2gj & pw2ga\n"
        "      -d, --device touch          Alias for k5w, k5g & k5gb\n"
        "      -d, --device paperwhite     Alias for pw, pwg, pwgc, pwgb, pwgj & pwgbr\n"
        "      -d, --device paperwhite2    Alias for pw2, pw2j, pw2g, pw2gb, pw2gr, pw2gj & pw2ga\n"
...
int kindle_info_main(int argc, char *argv[])
{
    ...
    if(device == KindlePaperWhite2Wifi || device == KindlePaperWhite2WifiJapan || device == KindlePaperWhite2Wifi3G || device == ValidKindlePinot_0xD6 || device == KindlePaperWhite2Wifi3GEurope || device == KindlePaperWhite2Wifi3GRussia || device == KindlePaperWhite2Wifi3GJapan || device == KindlePaperWhite2Wifi3GAfrica)
